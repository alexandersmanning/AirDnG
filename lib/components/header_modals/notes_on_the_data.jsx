					...
					<Modal 
						...
						<content className="about-container">
							<section className="about-section">
								...
								<p className="about-text">This site was built using React-Redux, in addition to d3 for the interactive graphs. Data for the site was provided by Inside AirBnB, who has an up to date dump of listings in different major cities.</p>
