...
/***/ function(module, exports, __webpack_require__) {
	...
	var _analyze_data = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./utils/analyze_data.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }
	
	var d3tip = __webpack_require__(5)(d3);
	// let jsonData = require('../assets/data_sets/words_by_neighbourhoods.json');
	
	
	document.addEventListener("DOMContentLoaded", function () {
		// let word_new = JSON.parse(jsonData)
		// I need to create a file for analyzing the data using JS
		var height = window.innerHeight;
		var width = window.innerWidth;
		debugger;
		var word_new = (0, _analyze_data.getNeighborhoods)(["Seacliff"]);
